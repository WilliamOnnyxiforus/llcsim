...
function ClassTypesForm() {
    const router = useRouter();
    const { id } = router.query; // Access the dynamic route parameter

    const formName = id === 'new' ? 'New class type form' : 'Edit class type form'
    ...
    const handleSubmit = async (e) => {
        ...
        const createRes = await fetch(`/api/classtypes`, {
            method: formMethod,
            headers: {
